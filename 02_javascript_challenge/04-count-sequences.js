...
const count = (data) => {return data.reduce((total, item, index) => {console.log(item,item === data[index + 2]);console.log(item !== data[index + 1]);const match = item === data[index + 2] && item !== data[index + 1]
    if (match) {
      return total + 1
    }
    return total
